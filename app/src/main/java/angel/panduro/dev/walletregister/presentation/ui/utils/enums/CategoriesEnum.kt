...
enum class CategoriesEnum(val description: String, val icon: Int, val color: Color) {
    ...
    companion object Companion {
        val options: List<CategoriesEnum> = entries
        ...
        fun getCategoriesByDescription(description: String): CategoriesEnum{
